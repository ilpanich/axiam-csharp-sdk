...
/// <c>ActorType.Unknown</c> rather than failing the response it arrived in (&#167;27.11 rule 1)
...
/// </para>
/// </remarks>
[JsonConverter(typeof(WireEnumConverter<ActorType>))]
public enum ActorType
{
    ...
    /// <summary>The server's <c>ServiceAccount</c> value.</summary>
    [WireName("ServiceAccount")]
    ServiceAccount,

    /// <summary>The server's <c>System</c> value.</summary>
    [WireName("System")]
    System,
