...
/// <c>PgpKeyPurpose.Unknown</c> rather than failing the response it arrived in (&#167;27.11
...
/// </para>
/// </remarks>
[JsonConverter(typeof(WireEnumConverter<PgpKeyPurpose>))]
public enum PgpKeyPurpose
{
    /// <summary>The server's <c>AuditSigning</c> value.</summary>
    [WireName("AuditSigning")]
    AuditSigning,

    /// <summary>The server's <c>Export</c> value.</summary>
    [WireName("Export")]
    Export,
